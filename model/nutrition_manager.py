class NutritionManager:
    ...
    def update_nutrition(self, selected_ingredients):
        ...
        :param selected_ingredients: A list of dictionaries, each containing 'protein', 'carbs', and 'calories' for an ingredient.
        """
        # Accumulate nutrition values from each ingredient
        for ingredient in selected_ingredients:
            self.nutrition_data['protein'] += ingredient.get('protein', 0)
            self.nutrition_data['carbs'] += ingredient.get('carbohydrates', 0)
